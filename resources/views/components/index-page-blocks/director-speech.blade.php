<section x-data="revealOnScroll()" class="page-block page-block--director-speech container bg-gradient-to-br from-[#5CACF0]/[0.13] to-[#0E3A5C]/[0.13] lg:pb-0 lg:items-center rounded-[32px] flex lg:flex-col px-14 lg:px-4 py-10 relative justify-between mb-14">
    ...
    <div class="flex flex-col">
        ...
        <h2 class="text-5xl mt-5 uppercase leading-[120%]">@lang('Обращение<br>генерального<br>директора')</h2>
    </div>
    <div class="flex flex-col"> <img src="/fixed/director-sign.png" class="w-52" alt="">
        <h3 class="text-blue-500 text-2xl">
            @lang('А. В. Рюмин<br>Генеральный директор<br>ПАО «Россети»<br>')
        </h3>
    </div>
</section>
