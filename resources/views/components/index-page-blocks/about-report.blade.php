<section class="mb-12 rounded-2xl overflow-hidden p-12 lg:p-4 flex flex-col gap-28 lg:gap-12 container relative bg-cover bg-center bg-no-repeat" style="background-image: url('/fixed/bg-nature.jpg')">
