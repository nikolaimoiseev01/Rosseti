<section class="mb-12 rounded-2xl overflow-hidden p-12 flex flex-col gap-28 container relative bg-cover bg-center bg-no-repeat" style="background-image: url('/fixed/bg-nature.jpg')">
    ...
    <div class="flex justify-between w-full">
        ...
        <div class="ml-auto flex flex-col rounded-[10px]
            ...
            @endphp
            <div class="grid grid-cols-[max-content_max-content_max-content] gap-x-12 gap-y-6">
        ...
        <div class="grid grid-cols-2 gap-2">
            ...
            p-5 text-white">
                ...
                <ul class="list-disc list-outside pl-6">
                    <li class="text-white">Рекомендации Банка России по раскрытию публичными акционерными обществами нефинансовой информации, связанной с деятельностью таких обществ</li>
                    <li class="text-white">Рекомендации ПАО Московская Биржа об утверждении Дополнительных правил, требований и рекомендаций по раскрытию информации эмитентами, акции которых включены в Первый или Второй уровень</li>
                    <li class="text-white">Методологии российских рейтинговых агентств по присвоению ESG-рейтингов нефинансовым компаниям</li>
                </ul>
            </div>
            <div class="ml-auto flex flex-col rounded-[10px]
            bg-gradient-to-br from-white/25 to-white/[0.03]
            ...
            p-5 text-white">
                Международные
                <ul class="list-disc list-outside pl-6">
                    <li class="text-white">Стандарты Глобальной инициативы по отчетности в области устойчивого развития 2021 (Global Reporting Initiative (GRI) Standards, GRI) </li>
                    <li class="text-white">Стандарт по взаимодействию со стейкхолдерами АА1000SES</li>
                    <li class="text-white">Отраслевое приложение GRI для электроэнергетической отрасли, The Electric Utilities Sector Disclosures</li>
                </ul>
            </div>
        </div>
    </div>
