...
<section class="container py-10 text-[#4A4A4A]">
    <h3 class="mb-6 text-center text-[24px] text-blue-500 leading-snug md:text-left md:text-[16px]">
        Процедура выявления существенных тем и определение существенности воздействия:
    </h3>

    <div class="grid grid-cols-[1fr_1.7fr_1fr_1.15fr_0.9fr] gap-x-2 lg:grid-cols-1 lg:gap-3">
                ...
                <div class="h-[68px] relative">
                    ...
                    @endif
                        @if($topBlue['arrow_down'] ?? false)
                            <div
                                class="absolute bottom-[-14px] left-1/2 z-10 -translate-x-1/2 p-2 rounded-full bg-white lg:hidden">
