        ...
        [
            'blocks' => [
                [
                    'row' => 'top',
                    'bg' => 'blue',
                    'text' => __('Внутренняя группа по вопросам<br>устойчивого развития'),
                    'arrows' => [
                        [
                            'position' => 'bottom',
                            'bg' => 'grey',
                ...
                [
                    'row' => 'center',
                    'bg' => 'grey',
                    'text' => __('Анализ контекста<br>и трендов'),
                    'arrows' => [
                        [
                            'position' => 'right',
                            'bg' => 'white',
        ...
        [
            'blocks' => [
                [
                    'row' => 'center',
                    'bg' => 'grey',
                    'text' => __('Формирование списка потенциально существенных тем на основе обзора отраслевых практик, рекомендаций, национальных и международных стандартов'),
                    'arrows' => [
                        [
                            'position' => 'right',
                            'bg' => 'white',
        ...
        [
            'blocks' => [
                [
                    'row' => 'top',
                    'bg' => 'blue',
                    'text' => __('Внутренние<br>Заинтересованные стороны'),
                    'arrows' => [
                        [
                            'position' => 'bottom',
                            'bg' => 'white',
                ...
                [
                    'row' => 'center',
                    'bg' => 'grey',
                    'text' => __('Анкетирование<br>респондентов'),
                    'arrows' => [
                        [
                            'position' => 'right',
                            'bg' => 'white',
                ...
                [
                    'row' => 'bottom',
                    'bg' => 'blue',
                    'text' => __('Внешние<br>Заинтересованные стороны'),
                    'arrows' => [
                        [
                            'position' => 'top',
                            'bg' => 'white',
        ...
        [
            'blocks' => [
                [
                    'row' => 'center',
                    'bg' => 'grey',
                    'text' => __('Анализ результатов анкетирования, приоритизация<br>и утверждение существенных тем'),
                    'arrows' => [
                        [
                            'position' => 'right',
                            'bg' => 'white',
        ...
        [
            'blocks' => [
                [
                    'row' => 'center',
                    'bg' => 'grey',
                    'text' => __('Раскрытие информации<br>в Отчете'),
                ],
            ],
        ],
    ];
...
<section x-data="revealOnScroll()" class="page-block page-block--procedure container mb-16 text-[#4A4A4A]">
    <h3
        x-data="revealOnScroll()"
        class="mb-6 text-center text-[24px] leading-snug text-blue-500 md:text-left md:text-[16px]"
    >
        {{ __('Процедура выявления существенных тем и определение существенности воздействия:') }}
    </h3>
