    ...
    <div class="grid grid-cols-2 gap-2 lg:grid-cols-1">
        <div x-data="revealOnScroll()" class="rounded-[10px] bg-[#F1F6FE] px-10 py-8 md:px-5">
            ...
            <div class="space-y-5 leading-[1.6] text-[#4A4A4A]">
                <p>
                    {{ __('Доступная и качественная электроэнергия в каждый дом, учреждение и производство') }}
                    {{ __('для комфортной жизни людей, ведения бизнеса и развития экономики страны.') }}
                </p>

                <p>
                    {{ __('Обеспечение надежного и доступного электроснабжения — ключевой элемент социальной') }}
                    {{ __('ответственности Группы компаний «Россети», способствующий повышению благополучия граждан,') }}
                    {{ __('развитию социально-экономического потенциала и укреплению единства страны.') }}
                </p>
            </div>
        </div>
