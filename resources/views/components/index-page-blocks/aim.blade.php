@php
    $goals = [
        __('Создание единого электросетевого комплекса Российской Федерации путем консолидации электросетевых активов под управлением Группы компаний «Россети»'),
        __('Повышение эффективности функционирования электросетевого комплекса'),
        __('Обеспечение реализации национальных проектов Российской Федерации'),
        __('Обеспечение надежности и доступности электроснабжения'),
        __('Обеспечение технологического суверенитета'),
    ];
@endphp

<section x-data="revealOnScroll()" class="page-block page-block--aim container mb-16">
    <div
    ...
    >
        <h2 x-data="revealOnScroll()" class="mb-7 text-white text-7xl font-light uppercase leading-[1.08] md:text-[34px]">
            {!! __('Ключевая цель в области<br>устойчивого развития') !!}</h2>
        ...
        <p x-data="revealOnScroll()" class="max-w-[620px] text-white text-2xl md:text-xl leading-[28px]">
            ...
            {{ __('в рамках своей операционной деятельности, а также формировать дополнительную ценность для всех') }}
            {{ __('заинтересованных сторон в контексте национальных и глобальных задач.') }}
        </p>
    </div>
    ...
    <div class="grid grid-cols-2 gap-2 lg:grid-cols-1">
        <div x-data="revealOnScroll()" class="rounded-[10px] bg-[#F1F6FE] px-10 py-8 md:px-5">
            ...
            <div class="space-y-5 leading-[1.6] text-[#4A4A4A]">
                <p>
                    {{ __('Доступная и качественная электроэнергия в каждый дом, учреждение и производство для комфортной жизни людей, ведения бизнеса и развития экономики страны.') }}
                </p>

                <p>
                    {{ __('Обеспечение надежного и доступного электроснабжения — ключевой элемент социальной ответственности Группы компаний «Россети», способствующий повышению благополучия граждан, развитию социально-экономического потенциала и укреплению единства страны.') }}
                </p>
            </div>
        </div>
