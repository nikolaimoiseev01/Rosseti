@php
    $buttons = [
        __('Забота о потребителях'),
        __('Цифровые технологии'),
    ];
@endphp
        ...
        <div class="relative z-10">
            ...
            <div class="grid grid-cols-[480px_1fr] gap-12 md:grid-cols-1 md:gap-5">
                <p x-data="revealOnScroll()" class="text-2xl md:text-xl leading-7 text-white">
                    {{ __('В отчетном году сохранен ранее применяемый методологический подход, уточнен перечень существенных тем.') }}
                </p>

                <div>
                    <p x-data="revealOnScroll()" class="mb-5 max-w-[660px] text-2xl md:text-xl leading-7 text-white">
                        {{ __('Анализ стратегических приоритетов Группы «Россети» в условиях цифровой трансформации, возросшие требования к скорости, прозрачности и цифровой доступности услуг выявили необходимость выделения двух существенных тем, оказывающих значимое воздействие на устойчивость и надежность электросетевого комплекса.') }}
                    </p>
