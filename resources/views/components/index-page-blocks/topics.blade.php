@php
    $tables = [
        [
            ['num' => 1, 'theme' => __('Обеспечение надежного и качественного электроснабжения'), 'aspect' => __('Управленческий'), 'priority' => __('Высокий')],
            ['num' => 2, 'theme' => __('Здоровье и безопасность на рабочем месте'), 'aspect' => __('Социальный'), 'priority' => __('Высокий')],
            ['num' => 3, 'theme' => __('Влияние на социально-экономическое развитие регионов присутствия'), 'aspect' => __('Социальный'), 'priority' => __('Высокий')],
            ['num' => 4, 'theme' => __('Забота о потребителях'), 'aspect' => __('Социальный'), 'priority' => __('Высокий')],
            ['num' => 5, 'theme' => __('Развитие кадрового потенциала'), 'aspect' => __('Социальный'), 'priority' => __('Высокий')],
            ['num' => 6, 'theme' => __('Обеспечение кибербезопасности и защиты данных'), 'aspect' => __('Управленческий'), 'priority' => __('Высокий')],
            ['num' => 7, 'theme' => __('Цифровые технологии'), 'aspect' => __('Управленческий'), 'priority' => __('Высокий')],
        ],
        [
            ['num' => 8, 'theme' => __('Соблюдение прав человека'), 'aspect' => __('Социальный'), 'priority' => __('Высокий')],
