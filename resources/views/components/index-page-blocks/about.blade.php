<section id="about" class="page-block page-block--about container mx-auto flex flex-col gap-16 py-24 xl:gap-10 md:grid-cols-1 md:py-16 sm:px-4 mb-14">
    <div x-data="revealOnScroll()" class="will-change-transform flex w-full lg:flex-col">
        <h2 class="lg:mb-4">Мы — Группа<br>{{ __('компаний «Россети»') }}</h2>
    ...
    <div x-data="revealOnScroll()" x-data="revealOnScroll()" class="flex max-w-5xl mx-auto gap-16 lg:flex-col">
        <h2 class="uppercase leading-[100%]">Мы стремимся быть надежной<br>опорой, чтобы вы могли жить,<br>{{ __('работать и развиваться.') }}</h2>
