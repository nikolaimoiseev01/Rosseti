<section id="about" id="about" class="container mx-auto flex flex-col gap-16 py-24 xl:gap-10 md:grid-cols-1 md:py-16 sm:px-4 mb-36">
    ...
    <div x-data="revealOnScroll()" x-data="revealOnScroll()" class="flex max-w-5xl mx-auto gap-16">
