<style>
    ...
    .rf-map #map-tooltip .tooltip-title {
        font-weight: bold;
        font-size: 16px;
        margin-bottom: 8px;
        color: #2497E8;
    ...
    .rf-map #map-tooltip .tooltip-info {
        display: flex;
        flex-direction: column;
        gap: 4px;
    }

    .rf-map #map-tooltip .tooltip-item {
        display: flex;
        gap: 8px;
        align-items: flex-start;
    }

    .rf-map #map-tooltip .tooltip-marker {
        position: relative;
        display: flex;
        align-items: center;
        justify-center;
    ...
    .rf-map #map-tooltip .tooltip-marker-dot {
        width: 4px;
        height: 4px;
        background: #60A5FA;
        border-radius: 50%;
    ...
    .rf-map #map-tooltip .tooltip-marker-line {
        width: 2px;
        height: 150%;
        position: absolute;
        top: 100%;
    ...
    .rf-map #map-tooltip .tooltip-text {
        font-size: 13px;
        line-height: 16px;
    }
    ...
    .district-links .district-link {
        transition: all 0.3s ease;
        padding: 8px 0;
    }

    .district-links .district-link:hover {
        background-color: rgba(36, 151, 232, 0.05);
    }

    .district-links .district-link.dimmed {
        opacity: 0.3;
    }
...
<path data-district-slug="szfo" data-district="Северо-Западный федеральный округ" data-id="enabled"
      ...
      stroke="#606778" stroke-width="0.22456220687904804"></path>
        ...
        <path data-district-slug="pfo" data-district="Приволжский федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="Белгородская область" data-code="RU-BEL"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="szfo" data-district="Северо-Западный федеральный округ" data-id="enabled"
              data-region="Мурманская область" data-code="RU-MUR"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="dfo" data-district="Дальневосточный федеральный округ" data-id="enabled"
              data-region="Еврейская автономная область" data-code="RU-YEV"
        ...
        <path data-district-slug="skfo" data-district="Северо-Кавказский федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="pfo" data-district="Приволжский федеральный округ" data-id="enabled"
              data-region="Пермский край" data-code="RU-PER"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="Рязанская область" data-code="RU-RYA"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="Смоленская область" data-code="RU-SMO"
        ...
        <path data-district-slug="sbfo" data-district="Сибирский федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="Липецкая область" data-code="RU-LIP"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="skfo" data-district="Северо-Кавказский федеральный округ" data-id="enabled"
              data-region="Ставропольский край" data-code="RU-STA"
              d="M48.4809,258.3759l.4025-.6708-.2012-.6708H47.81l-.805.6708-.1342-.6708.0671-.6708h-.6708l-.47-.6708-1.14-1.3417-1.3417-.6708-.3354,1.3417-.3354.6708-1.2075-.6708-1.0062-.6708-.8721,1.3417-.5367,2.0125.6037,2.0125-.4025,1.3417.5367.6708-1.0062,1.3417-1.0733.6708-.2683-.6708h-.3354l.0671,2.6833,1.0733,1.3417.8721,2.0125h.9392l.8721.6708-.2683.6708H39.0893l-1.14.6708.2683.6708h.7379l-.5367.6708-.805,1.3417h1.5429l1.7442.6708.3354.6708-.1342.6708,1.8783,1.3417h1.4758l1.2746,1.3417.7379.6708h.3354l-.5367.6708h-.6708l1.6771,1.3417.2683,2.0125,1.4758-.6708,1.0062-.6708.2683.6708.5367.6708h1.2075l.3354-2.0125-1.0062-.6708h2.2808l.1342-1.3417H53.378l1.0062-.6708.9392.6708,1.8783-1.3417,1.2075-.6708-.5367-3.3541L56.33,270.4508l-.9392-1.3417-.4025-1.3417.47-3.3541-.805-1.3417L53.6463,261.73l-.5367-1.3417-.6038-2.0126Z"
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="szfo" data-district="Северо-Западный федеральный округ" data-id="enabled"
              data-region="Новгородская область" data-code="RU-NGR"
        ...
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="Воронежская область" data-code="RU-VOR"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="ufo" data-district="Южный федеральный округ" data-id="enabled"
              data-region="Республика Адыгея" data-code="RU-AD"
        ...
        <path data-district-slug="pfo" data-district="Приволжский федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="ufo" data-district="Южный федеральный округ" data-id="enabled"
              data-region="Астраханская область" data-code="RU-AST"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              data-region="
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="pfo" data-district="Приволжский федеральный округ" data-id="enabled"
              data-region="Республика Мордовия" data-code="RU-MO"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="sbfo" data-district="Сибирский федеральный округ" data-id="enabled"
              data-region="Республика Тыва" data-code="RU-TY"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="cfo fed" data-id="enabled" data-region="Москва" data-code="RU-MOW"
        ...
        <path data-district-slug="cfo" data-district="Центральный федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="szfo" data-district="Северо-Западный федеральный округ" data-id="enabled"
              data-region="Калининградская область" data-code="RU-KGD"
        ...
        <path data-district-slug="skfo" data-district="Северо-Кавказский федеральный округ" data-id="enabled"
              ...
              stroke="#606778" stroke-width="0.22456220687904804"></path>
        <path data-district-slug="urfo" data-district="Уральский федеральный округ" data-id="enabled"
              data-region="Курганская область" data-code="RU-KGN"
        ...
        <path data-district-slug="ufo" data-district="Южный федеральный округ" data-id="enabled"
              data-region="Луганская Народная Республика" data-code="RU-LNR"
                    ...
                    @foreach($district['info'] as $key => $item)
                        <div class="flex gap-2 w-fit">
                            <div class="relative flex items-center justify-center w-[18px] min-w-[18px] bg-white h-[18px] border rounded-full" style="border-color: #2497E8;">
                                ...
                                @if($key < count($district['info']) - 1)
                                    <div class="w-[2px] !p-0 h-[150%] absolute top-full bg-gradient-to-b from-blue-400 to-transparent"></div>
                                @endif
                            </div>
        ...
        (function () {
            function initMap() {
                ...
                function addDistrictNumbers() {
                    ...
                    Object.keys(districtCentroids).forEach(slug => {
                        const centroid = districtCentroids[slug];
                        if (!centroid) return;
                        ...
                        text.setAttribute('class', 'district-number');
                        text.textContent = centroid.number;

                        // Add circle background for better visibility
                ...
                function highlightDistrict(districtSlug) {
                    ...
                    regions.forEach(region => {
                        const regionSlug = region.getAttribute('data-district-slug');
                    ...
                    // Подсветка ссылок в перечне
                    districtLinks.forEach(link => {
                        const linkSlug = link.getAttribute('data-district-slug');
                        if (linkSlug === districtSlug) {
                            // link.classList.add('bg-blue-500', 'text-white', 'border-blue-500');
                            link.classList.remove('dimmed');
                        } else {
                            // link.classList.remove('bg-blue-500', 'text-white', 'border-blue-500');
                ...
                function resetHighlight() {
                    regions.forEach(region => {
                        region.classList.remove('region-hover', 'dimmed');
                    });

                    districtLinks.forEach(link => {
                        link.classList.remove('bg-blue-500', 'text-white', 'border-blue-500', 'dimmed');
                    });
                }

                function makeRegionsHover() {
                    ...
                    regions.forEach(region => {
                        region.addEventListener('mouseenter', (e) => {
                            ...
                            // Тултип с информацией об округе
                            const districtData = window.districtsData.find(d => d.slug === districtSlug);
                            let tooltipContent = `<div class="tooltip-title">${districtData ? districtData.name : districtName}</div>`;

                            if (districtData && districtData.info) {
                                tooltipContent += '<div class="tooltip-info">';
                                districtData.info.forEach((item, index) => {
                                    const hasLine = index < districtData.info.length - 1;
                                    tooltipContent += `
                                        <div class="tooltip-item">
                                            <div class="tooltip-marker">
                                                <div class="tooltip-marker-dot"></div>
                                                ${hasLine ? '<div class="tooltip-marker-line"></div>' : ''}
                                            </div>
