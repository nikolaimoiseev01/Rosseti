...
@if($style === 'line')
    <hr class="border-t border-[#E1E7F0] {{ $spacingTop }} {{ $spacingBottom }}">
@elseif($style === 'thick')
    <hr class="border-t-2 border-[#00355A]/20 {{ $spacingTop }} {{ $spacingBottom }}">
@elseif($style === 'space')
    <div class="{{ $spacingTop }} {{ $spacingBottom }}"></div>
@elseif($style === 'dots')
    <div class="flex justify-center gap-2 {{ $spacingTop }} {{ $spacingBottom }}">
