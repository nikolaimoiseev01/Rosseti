...
<div id="{{ $blockId }}" x-data="revealOnScroll()" style="overflow-x: auto; overflow-y: visible;" class="page-block page-block--table rounded-xl border border-[#E1E7F0] {{ $spacingTop }} {{ $spacingBottom }}">
