...
<div id="{{ $blockId }}" x-data="revealOnScroll()" class="!overflow-visible page-block page-block--table overflow-x-auto rounded-xl border border-[#E1E7F0] {{ $spacingTop }} {{ $spacingBottom }}">
