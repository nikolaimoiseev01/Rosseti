...
<blockquote id="{{ $blockId }}" x-data="revealOnScroll()" class="page-block page-block--quote relative bg-[#F7F9FC] rounded-2xl p-8 pr-14 border-l-4 border-[#00355A] {{ $spacingTop }} {{ $spacingBottom }}">
