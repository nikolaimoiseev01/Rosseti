...
@if($style === 'card_blue')
    <div class="rounded-2xl p-8 flex flex-col justify-between items-stretch min-h-[200px]" style="background-color: {{ $colorHex }}">
...
@elseif($style === 'card_light')
    <div class="rounded-2xl bg-[#F7F9FC] border border-[#E1E7F0] p-8 flex flex-col justify-between items-stretch min-h-[200px]">
        @if(!empty($data['context']))
